...
class CameraApi {
  ...
  Future<List<String>> takePictureBurst(int count) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_android.CameraApi.takePictureBurst$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
  ...
  Future<bool> supportsBurstCapture() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_android.CameraApi.supportsBurstCapture$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
  ...
  Future<int> getBurstCaptureMaxCount() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.camera_android.CameraApi.getBurstCaptureMaxCount$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
